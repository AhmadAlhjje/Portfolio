      ...
      <section id="home" className="min-h-screen flex flex-col md:flex-row items-center justify-center px-8 py-16 bg-[#323946]">
        ...
        >
          ...
          <p className="text-lg mb-6 text-white">
            I have hands-on experience in developing fullstack applications, integrating React.js for intuitive front-end 
            interactions and Node.js/Express.js for secure and efficient back-end operations.
          </p>

          {/* Social Media Icons */}
          <div className="flex justify-center md:justify-start space-x-4 mb-6">
            <a
              href="https://www.facebook.com/ahmadalhjje9?mibextid=ZbWKwL"
              target="_blank"
            ...
            <a
              href="https://www.instagram.com/ahmadalhjj9?igsh=MWt0cmp3MGh1eTFxMQ=="
              target="_blank"
              rel="noopener noreferrer"
              className="flex justify-center items-center w-10 h-10 border-2 border-[#0ef] rounded-full text-[#0ef] hover:bg-[#0ef] hover:text-[#323946] transition-all duration-500"
            >
            ...
            <a
              href="https://www.linkedin.com/in/%D9%90%D9%90ah%D9%90mad-alhjje-baa973303/"
              target="_blank"
              rel="noopener noreferrer"
              className="flex justify-center items-center w-10 h-10 border-2 border-[#0ef] rounded-full text-[#0ef] hover:bg-[#0ef] hover:text-[#323946] transition-all duration-500"
            >
